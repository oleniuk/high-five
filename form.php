...
<html lang="ru">
    ...
    <meta name="viewport" content="width=device-width">
        <title>Вітаємо! Твоя форма прийнята!</title>
...
<!-- End Meta Pixel Code -->
    ...
    <div class="wrapper">
        <div class="block_success">          
            <h2 style="text-transform: uppercase;">Вітаємо! Твоя форма прийнята!</h2>
            <p class="success">
            Найближчим часом ми зв'яжемось з тобою
            </p>
            <h3 class="success">
            Будь ласка, перевір правильність введеної інформації.
            </h3>
            <!--<div class="success">
                <ul class="list_info">
            ...
            <p class="fail success">Якщо ти зробив помилку під час заповнення форми, будь ласка, <a href="javascript: history.back(-1);">заповни форму ще раз</a></p>      
